...
:loop
if "%~1"=="" goto end
for /L %%i in (160,-20,60) do call %benchmark_bat% "%~1" "%~n1_rav1e_20190713_s2_tunepsnr_q%%i.mp4" "--quantizer %%i --speed 2 --tune psnr --keyint 250 --threads 8 --tile-cols-log2 2 --tile-rows-log2 2" rav1e 20190713_s2_tunepsnr
