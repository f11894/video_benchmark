...
:loop
if "%~1"=="" goto end
for /L %%i in (160,-20,60) do call %benchmark_bat% "%~1" "%~n1_rav1e_20190921_s2_tunepsnr_1pass_q%%i.mp4" "--quantizer %%i --speed 2 --tune psnr --keyint 250 --threads 8 --tile-cols 2 --tile-rows 2" rav1e 20190921_s2_tunepsnr_1pass_q
