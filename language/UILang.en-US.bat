...
set "MessageInputVideoInfoDuration=Duration                    : %%Duration_sexagesimal%%"
...
set "MessageMetricCompare=Calculating SSIM PSNR VMAF XPSNR SSIMULACRA2 for "%%OutputVideo%%""
set "MessageMetricCompareError=Calculation of SSIM PSNR VMAF XPSNR SSIMULACRA2 failed"
