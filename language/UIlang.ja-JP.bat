...
set "MessageMetricCompare="%%OutputVideo%%"のSSIM PSNR VMAF XPSNR SSIMULACRA2を算出しています"
set "MessageMetricCompareError=SSIM PSNR VMAF XPSNR SSIMULACRA2の算出に失敗しました"
