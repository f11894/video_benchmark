...
for /L %%i in (50,-4,26) do call %benchmark_bat% -codec SVT-AV1 -i "%~1" -o "%~n1_SVT-AV1_encmode2_2pass_q%%i.mp4" -cmd "--preset 2 --pass 2 --keyint 63 --irefresh-type 2 -q %%i" -csvsuf encmode2_2pass_q
shift
goto loop
:end
exit /b
