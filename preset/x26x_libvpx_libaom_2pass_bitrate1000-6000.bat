...
:loop
if "%~1"=="" goto end
for /L %%i in (1000,1000,6000) do call %benchmark_bat% "%~1" "%~n1_rav1e_20190713_s2_tunepsnr_2pass_%%ikbps.mp4" "--bitrate %%i --second-pass rav1e_stats.log --speed 2 --tune psnr --keyint 250 --threads 8 --tile-cols-log2 2 --tile-rows-log2 2" rav1e 20190713_s2_tunepsnr_2pass_bitrate
