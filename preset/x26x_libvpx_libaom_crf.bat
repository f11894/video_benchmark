...
for /L %%i in (55,-5,25) do call %benchmark_bat% -codec libaom -i "%~1" -o "%~n1_libaom_c1_2pass_q%%i.mp4" -cmd "--ivf --cpu-used=1 --threads=8 --tile-columns=2 --tile-rows=2 --pass=2 --passes=2 --end-usage=q --cq-level=%%i --kf-max-dist=250" -csvsuf c1_2pass_q
rem 10bit example
