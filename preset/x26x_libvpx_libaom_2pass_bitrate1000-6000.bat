...
for /L %%i in (1000,1000,6000) do call %benchmark_bat% -codec libaom -i "%~1" -o "%~n1_libaom_c0_%%ikbps.mp4" -cmd "--ivf --cpu-used=0 --threads=8 --tile-columns=2 --tile-rows=2 --end-usage=vbr --pass=2 --passes=2 --target-bitrate=%%i --kf-max-dist=250" -csvsuf c0_2pass_bitrate
